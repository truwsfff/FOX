...
class Design:
    def __init__(self):
        ...
        self.setting_button_img = pygame.image.load(os.path.join(data_path, "btn_setting.png"))
        ...
        self.side_buttons = {
            "SETTING":  {"rect": pygame.Rect(1510, 248, 400, 113), "image": self.setting_button_img},
        ...
        self.text_2 = self.font_min.render('Settin', True, pygame.Color('white'))
